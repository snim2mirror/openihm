...
cropincome = Table('cropincome', metadata,
    ...
    Column(u'unitsproduced', DOUBLE(asdecimal=True), default=text(u"'0'")),
    Column(u'unitssold', DOUBLE(asdecimal=True)),
    Column(u'unitprice', DOUBLE(asdecimal=True)),
    Column(u'otheruses', DOUBLE(asdecimal=True), default=text(u"'0'")),
    Column(u'unitsconsumed', DOUBLE(asdecimal=True), default=text(u"'0'")),
    Column(u'pid', Integer, primary_key=True, nullable=False),
    Column(u'preferenceprice', DOUBLE(asdecimal=True), default=text(u"'100'")),
    Column(u'preferenceproduction', DOUBLE(asdecimal=True), default=text(u"'100'")),
    ForeignKeyConstraint([u'hhid', u'pid'], 
                         [u'households.hhid',
                          u'households.pid'],
                         ondelete='CASCADE', onupdate='CASCADE',
...
diet = Table('diet', metadata,
    ...
    Column(u'modelprice', DOUBLE(asdecimal=True), nullable=False, default=text(u"'0'")),
...
employmentincome = Table('employmentincome', metadata,
    ...
    Column(u'pid', Integer, primary_key=True, nullable=False),
    Column(u'preferenceincome', DOUBLE(asdecimal=True), default=text(u"'100'")),
    ForeignKeyConstraint([u'hhid', u'pid'],
                         [u'households.hhid',
                          u'households.pid'],
                         ondelete='CASCADE', onupdate='CASCADE',
...
households = Table('households', metadata,
    ...
    Column(u'totalassetvalue', DOUBLE(asdecimal=True), nullable=False, default=text(u"'0'")),
    Column(u'totalincomevalue', DOUBLE(asdecimal=True), nullable=False, default=text(u"'0'")),
    Column(u'totalexpenditure', DOUBLE(asdecimal=True), nullable=False, default=text(u"'0'")),
...
standardofliving = Table('standardofliving', metadata,
    ...
    Column(u'modelprice', DOUBLE(asdecimal=True), default=text(u"'0'")),
    ForeignKeyConstraint([u'pid'],
                         [u'projects.pid'],
                         ondelete='CASCADE', onupdate='CASCADE',
...
transfers = Table('transfers', metadata,
    ...
    Column(u'cashperyear', DOUBLE(asdecimal=True), default=text(u"'0'")),
    Column(u'foodtype', VARCHAR(length=255)),
    Column(u'unitofmeasure', VARCHAR(length=45)),
    Column(u'unitsgiven', DOUBLE(asdecimal=True), default=text(u"'0'")),
    Column(u'unitsconsumed', DOUBLE(asdecimal=True), default=text(u"'0'")),
    Column(u'unitssold', DOUBLE(asdecimal=True), default=text(u"'0'")),
    Column(u'priceperunit', DOUBLE(asdecimal=True), default=text(u"'0'")),
    Column(u'preferenceprice', DOUBLE(asdecimal=True), default=text(u"'100'")),
    Column(u'preferenceproduction', DOUBLE(asdecimal=True), default=text(u"'100'")),
    ForeignKeyConstraint([u'hhid', u'pid'],
                         [u'households.hhid',
