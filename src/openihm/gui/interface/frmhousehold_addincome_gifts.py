...
Ui_AddHouseholdIncomeGifts, base_class = uic.loadUiType("gui/designs/ui_household_income_gifts.ui")

from mixins import MDIDialogMixin, MySQLMixin

class FrmHouseholdGiftsIncome(QDialog, Ui_AddHouseholdIncomeGifts, MySQLMixin, MDIDialogMixin):	
     ...
     def getGiftsTypes(self):
         ...
         query = '''SELECT sourceoftransfer FROM setup_transfers WHERE assistancetype='internal' OR assistancetype='unofficial' '''
