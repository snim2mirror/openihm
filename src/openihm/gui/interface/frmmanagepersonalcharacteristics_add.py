...
Ui_AddPersonalCharacteristic, QDialog = uic.loadUiType('./gui/designs/ui_managepersonalcharacteristic_add.ui')

class FrmAddPersonalCharacteristic (QDialog, Ui_AddPersonalCharacteristic):
     """FrmAddPersonalCharacteristic inherits QDialog"""
     ...
     def __init__ (self, parent = None,  characteristic=""):
         ...
         if self.characteristic != "":
             self.setWindowTitle("Edit Personal Characteristic")
             self.showDetails()
