...
#
# Created: Mon Apr 18 16:07:06 2011
...
class Ui_CropTypes(object):
    def setupUi(self, CropTypes):
        ...
        CropTypes.setTabOrder(self.comboBox, self.pushButton_3)
        CropTypes.setTabOrder(self.pushButton_3, self.comboBox_2)
        ...
        CropTypes.setTabOrder(self.lineEdit, self.pushButton)
