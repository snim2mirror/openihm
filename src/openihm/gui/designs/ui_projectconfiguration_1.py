...
# Form implementation generated from reading ui file 'ui_projectconfiguration_1.ui'
#
# Created: Sat Jan 22 14:14:17 2011
...
class Ui_ProjectConfiguration(object):
    def setupUi(self, ProjectConfiguration):
        ...
        self.lstAvailableCropTypes = QtGui.QListView(self.tabCrops)
        self.lstAvailableCropTypes.setGeometry(QtCore.QRect(10, 30, 261, 361))
        self.lstAvailableCropTypes.setObjectName(_fromUtf8("lstAvailableCropTypes"))
        ...
        self.lstSelectedCropTypes = QtGui.QListView(self.tabCrops)
        self.lstSelectedCropTypes.setGeometry(QtCore.QRect(370, 30, 261, 361))
        self.lstSelectedCropTypes.setObjectName(_fromUtf8("lstSelectedCropTypes"))
        ...
        self.lstAvailableEmployentTypes = QtGui.QListView(self.tabEmployment)
        self.lstAvailableEmployentTypes.setGeometry(QtCore.QRect(10, 30, 261, 361))
        self.lstAvailableEmployentTypes.setObjectName(_fromUtf8("lstAvailableEmployentTypes"))
        self.lstSelectedEmploymentTypes = QtGui.QListView(self.tabEmployment)
        self.lstSelectedEmploymentTypes.setGeometry(QtCore.QRect(370, 30, 261, 361))
        self.lstSelectedEmploymentTypes.setObjectName(_fromUtf8("lstSelectedEmploymentTypes"))
        ...
        self.lstAvailableLivestock = QtGui.QListView(self.tabLivestock)
        self.lstAvailableLivestock.setGeometry(QtCore.QRect(10, 30, 261, 361))
        self.lstAvailableLivestock.setObjectName(_fromUtf8("lstAvailableLivestock"))
        ...
        self.lstSelectedLivestock = QtGui.QListView(self.tabLivestock)
        self.lstSelectedLivestock.setGeometry(QtCore.QRect(370, 30, 261, 361))
        self.lstSelectedLivestock.setObjectName(_fromUtf8("lstSelectedLivestock"))
        ...
        self.lstAvailableTransfers = QtGui.QListView(self.tabTransfers)
        self.lstAvailableTransfers.setGeometry(QtCore.QRect(10, 30, 261, 361))
        self.lstAvailableTransfers.setObjectName(_fromUtf8("lstAvailableTransfers"))
        ...
        self.lstSelectedTransfers = QtGui.QListView(self.tabTransfers)
        self.lstSelectedTransfers.setGeometry(QtCore.QRect(370, 30, 261, 361))
        self.lstSelectedTransfers.setObjectName(_fromUtf8("lstSelectedTransfers"))
        ...
        self.lstAvailableWildFoods = QtGui.QListView(self.tabWildFoods)
        self.lstAvailableWildFoods.setGeometry(QtCore.QRect(10, 30, 261, 361))
        self.lstAvailableWildFoods.setObjectName(_fromUtf8("lstAvailableWildFoods"))
        self.lstSelectedWildFoods = QtGui.QListView(self.tabWildFoods)
        self.lstSelectedWildFoods.setGeometry(QtCore.QRect(370, 30, 261, 361))
        self.lstSelectedWildFoods.setObjectName(_fromUtf8("lstSelectedWildFoods"))
