...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuOutputs.setObjectName("menuOutputs")
        ...
        self.actionAboutOpenIHM.setObjectName("actionAboutOpenIHM")
        ...
        self.actionEnergy_Requirements.setObjectName("actionEnergy_Requirements")
        self.actionAdd = QtGui.QAction(MainWindow)
        self.actionAdd.setObjectName("actionAdd")
        self.actionHousehold_by_Characteristics = QtGui.QAction(MainWindow)
        self.actionHousehold_by_Characteristics.setObjectName("actionHousehold_by_Characteristics")
        self.actionManage_Currencies = QtGui.QAction(MainWindow)
        self.actionManage_Currencies.setObjectName("actionManage_Currencies")
        self.actionIncome_By_Source = QtGui.QAction(MainWindow)
        self.actionIncome_By_Source.setObjectName("actionIncome_By_Source")
        self.actionInitialise_Food_Energy_Table = QtGui.QAction(MainWindow)
        self.actionInitialise_Food_Energy_Table.setObjectName("actionInitialise_Food_Energy_Table")
        self.actionGenerate_Data_Entry_Sheets = QtGui.QAction(MainWindow)
        self.actionGenerate_Data_Entry_Sheets.setObjectName("actionGenerate_Data_Entry_Sheets")
        self.actionManage_Standard_of_Living_Items = QtGui.QAction(MainWindow)
        self.actionManage_Standard_of_Living_Items.setObjectName("actionManage_Standard_of_Living_Items")
        self.actionConfigure_Project_Income = QtGui.QAction(MainWindow)
        self.actionConfigure_Project_Income.setObjectName("actionConfigure_Project_Income")
        self.actionDisposable_Income = QtGui.QAction(MainWindow)
        self.actionDisposable_Income.setObjectName("actionDisposable_Income")
        self.actionInitialise_Energy_Requirement_Table = QtGui.QAction(MainWindow)
        self.actionInitialise_Energy_Requirement_Table.setObjectName("actionInitialise_Energy_Requirement_Table")
        self.actionLiving_Threshold = QtGui.QAction(MainWindow)
        self.actionLiving_Threshold.setObjectName("actionLiving_Threshold")
        ...
        self.menuOutputs.addAction(self.actionHousehold_Budget)
        ...
        QtCore.QObject.connect(self.actionCreate_Project, QtCore.SIGNAL("triggered()"), MainWindow.newProject)
        QtCore.QObject.connect(self.actionOpen_Project, QtCore.SIGNAL("triggered()"), MainWindow.openProject)
        QtCore.QObject.connect(self.actionFind_Project, QtCore.SIGNAL("triggered()"), MainWindow.findProject)
        QtCore.QObject.connect(self.actionClose_Project, QtCore.SIGNAL("triggered()"), MainWindow.closeProject)
        QtCore.QObject.connect(self.actionExit, QtCore.SIGNAL("triggered()"), MainWindow.close)
        QtCore.QObject.connect(self.actionAsset_Details, QtCore.SIGNAL("triggered()"), MainWindow.manageAssetDetails)
        QtCore.QObject.connect(self.actionIncome_Source_Details, QtCore.SIGNAL("triggered()"), MainWindow.manageIncomeDetails)
        QtCore.QObject.connect(self.actionExpenditure_Types, QtCore.SIGNAL("triggered()"), MainWindow.manageBaseExpenditureDetails)
        QtCore.QObject.connect(self.actionEdit_Project, QtCore.SIGNAL("triggered()"), MainWindow.editProject)
        QtCore.QObject.connect(self.actionConfigure_Project, QtCore.SIGNAL("triggered()"), MainWindow.configureProject)
        QtCore.QObject.connect(self.actionEdit_Household, QtCore.SIGNAL("triggered()"), MainWindow.editProjectHousehold)
        QtCore.QObject.connect(self.actionEnter_Household_Data, QtCore.SIGNAL("triggered()"), MainWindow.viewHouseholdData)
        QtCore.QObject.connect(self.actionFind_Household, QtCore.SIGNAL("triggered()"), MainWindow.findHousehold)
        QtCore.QObject.connect(self.actionView_All_Households_2, QtCore.SIGNAL("triggered()"), MainWindow.viewAllHouseholds)
        QtCore.QObject.connect(self.actionFood_Types, QtCore.SIGNAL("triggered()"), MainWindow.manageFoodTypes)
        QtCore.QObject.connect(self.actionAdd_Household, QtCore.SIGNAL("triggered()"), MainWindow.addHousehold)
        QtCore.QObject.connect(self.actionDelete_Household, QtCore.SIGNAL("triggered()"), MainWindow.delHousehold)
        QtCore.QObject.connect(self.actionHousehold_Characteristics_2, QtCore.SIGNAL("triggered()"), MainWindow.manageHouseholdCharacteristics)
        QtCore.QObject.connect(self.actionPersonal_Characteristics, QtCore.SIGNAL("triggered()"), MainWindow.managePersonalCharacteristics)
        QtCore.QObject.connect(self.actionAboutOpenIHM, QtCore.SIGNAL("triggered()"), MainWindow.aboutOpenIHM)
        QtCore.QObject.connect(self.actionEnergy_Requirements, QtCore.SIGNAL("triggered()"), MainWindow.viewFoodEnergyRequirements)
        QtCore.QObject.connect(self.actionManage_Currencies, QtCore.SIGNAL("triggered()"), MainWindow.manageCurrencies)
        QtCore.QObject.connect(self.actionManage_Standard_of_Living_Items, QtCore.SIGNAL("triggered()"), MainWindow.manageStandardOfLiving)
        QtCore.QObject.connect(self.actionHousehold_by_Characteristics, QtCore.SIGNAL("triggered()"), MainWindow.reportHouseholdsByCharacteristics)
        QtCore.QObject.connect(self.actionIncome_By_Source, QtCore.SIGNAL("triggered()"), MainWindow.reportHouseholdsByIncomeSource)
        QtCore.QObject.connect(self.actionInitialise_Food_Energy_Table, QtCore.SIGNAL("triggered()"), MainWindow.initialiseFoodEnergyLookupTable)
        QtCore.QObject.connect(self.actionGenerate_Data_Entry_Sheets, QtCore.SIGNAL("triggered()"), MainWindow.createDataEntrySheets)
        QtCore.QObject.connect(self.actionImport_Project_Data, QtCore.SIGNAL("triggered()"), MainWindow.importData)
        QtCore.QObject.connect(self.actionDisposable_Income, QtCore.SIGNAL("triggered()"), MainWindow.setReporttypeDI)
        QtCore.QObject.connect(self.actionInitialise_Energy_Requirement_Table, QtCore.SIGNAL("triggered()"), MainWindow.initialiseFoodRequirementTable)
        QtCore.QObject.connect(self.actionLiving_Threshold, QtCore.SIGNAL("triggered()"), MainWindow.setReporttypeAsLivingThreshold)
