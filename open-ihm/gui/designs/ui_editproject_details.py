...
#
# Created: Fri Mar 05 11:24:26 2010
...
class Ui_EditProject(object):
    def setupUi(self, EditProject):
        ...
        EditProject.resize(389, 261)
        EditProject.setMinimumSize(QtCore.QSize(389, 261))
        self.cmdSave = QtGui.QPushButton(EditProject)
        self.cmdSave.setGeometry(QtCore.QRect(20, 222, 75, 31))
        self.cmdSave.setObjectName("cmdSave")
        self.cmdCancel = QtGui.QPushButton(EditProject)
        self.cmdCancel.setGeometry(QtCore.QRect(300, 222, 75, 31))
