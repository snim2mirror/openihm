...
#
# Created: Thu Feb 25 15:02:25 2010
...
class Ui_LandTypes(object):
    def setupUi(self, LandTypes):
        ...
        LandTypes.resize(QtCore.QSize(QtCore.QRect(0,0,389,261).size()).expandedTo(LandTypes.minimumSizeHint()))
        LandTypes.setMinimumSize(QtCore.QSize(389,261))

        self.btnLandTypesClose = QtGui.QPushButton(LandTypes)
        self.btnLandTypesClose.setGeometry(QtCore.QRect(290,190,80,28))
        self.btnLandTypesClose.setObjectName("btnLandTypesClose")

        self.pushButton_3 = QtGui.QPushButton(LandTypes)
        self.pushButton_3.setGeometry(QtCore.QRect(60,190,80,28))
        ...
        self.pushButton.setGeometry(QtCore.QRect(180,190,80,28))
    ...
    def retranslateUi(self, LandTypes):
        LandTypes.setWindowTitle(QtGui.QApplication.translate("LandTypes", "Land Types", None, QtGui.QApplication.UnicodeUTF8))
