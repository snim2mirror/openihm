...
class MySQLProtocol(object):
    ...
    def __init__(self, conn, handshake=None):
        self.client_flags = 0
        self.conn = weakref.ref(conn) # MySQL Connection
        if handshake:
...
class Auth(PacketOut):
    ...
    def create(self, username=None, password=None, database=None,
        seed=None, charset=33):
        self.add_4_int(self.client_flags)
        self.add_4_int(10 * 1024 * 1024)
        self.add_1_int(charset)
        self.add_null(23)
