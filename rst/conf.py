...
project = u'open-ihm'
copyright = u'2011, University of Malawi, Evidence for Development, University of Wolverhampton'
...
latex_documents = [
  ('index', 'open-ihmdoc.tex', u'open-ihm Documentation',
   u'University of Malawi, Evidence for Devlopment, University of Wolverhampton',
   'manual'),
]
